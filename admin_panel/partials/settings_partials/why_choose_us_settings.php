...
<!-- Why Choose Us Modal -->
<!-- Scrollable Modal -->
<div class="modal fade my_modal_facility_us" id="editWhyChooseUsModal" tabindex="-1" role="dialog" aria-labelledby="editWhyChooseUsModalLabel" aria-hidden="true">
...
<div class="modal fade my_modal_add_us" id="addWhyChooseUsModal" tabindex="-1" aria-labelledby="addWhyChooseUsModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control shadow-none contact_us input_one" id="exampleFormControlInput3" required name="title_inp">

                        <span style="font-size: .7rem;">Description</span>
                        <input type="text" class="form-control shadow-none contact_us input_two" id="exampleFormControlInput3" required name="desc_inp">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control shadow-none contact_us input_three" id="exampleFormControlInput3" aria-describedby="basic-addon1" name="icon_inp" required>
                            <!-- icon -->
                        </div>
                    </div>
                </div>
