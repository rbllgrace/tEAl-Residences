...
<body>
        ...
        <div class="card">
            <div class="card-body">
                <div class="gen_and_edit">
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary btn_edit shadow-none" data-bs-toggle="modal" data-bs-target="#editAboutUsModal">
                        <i class="bi bi-pencil-square"></i>Edit
                    </button>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="gen_and_edit">
                    ...
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary btn_edit shadow-none" data-bs-toggle="modal" data-bs-target="#editFacilitiesModal">
                        <i class="bi bi-pencil-square"></i>Edit
                    </button>
                </div>
    ...
    <!-- Contact Us Modal -->
    <div class="modal fade my_modal_contact_us" id="editAboutUsModal" tabindex="-1" aria-labelledby="editAboutUsModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <!-- Scrollable Modal -->
    <div class="modal fade my_modal_facility_us" id="editFacilitiesModal" tabindex="-1" role="dialog" aria-labelledby="editFacilitiesModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form action="">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control shadow-none contact_us f1_inp" id="exampleFormControlInput3" name="f1" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control shadow-none contact_us icon1_inp" id="exampleFormControlInput3" name="icon1" aria-describedby="basic-addon1" required>
                                <!-- icon -->
                            </div>
                        </div>
                        ...
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control  shadow-none contact_us f2_inp" id="exampleFormControlInput3" name="f2" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control shadow-none contact_us icon2_inp" id="exampleFormControlInput3" name="icon2" required>
                                <!-- icon -->
                            </div>
                            ...
                            <div class="mb-1">
                                <label for="exampleFormControlInput3" class="form-label fw-bold f-title">Facility
                                    #3</label>
                                <input type="text" class="form-control  shadow-none contact_us f3_inp" id="exampleFormControlInput3" name="f3" required>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control shadow-none contact_us icon3_inp" id="exampleFormControlInput3" name="icon3" required>
                                    <!-- icon -->
                                </div>
                                ...
                                <div class="mb-1">
                                    <label for="exampleFormControlInput3" class="form-label fw-bold f-title">Facility
                                        #4</label>
                                    <input type="text" class="form-control  shadow-none contact_us f4_inp" id="exampleFormControlInput3" name="f4" required>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control shadow-none contact_us icon4_inp" id="exampleFormControlInput3" name="icon4" required>
                                        <!-- icon -->
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        <label for="exampleFormControlInput3" class="form-label fw-bold f-title">Facility
                                            #5</label>
                                        <input type="text" class="form-control  shadow-none contact_us f5_inp" id="exampleFormControlInput3" name="f5" required>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control shadow-none contact_us icon5_inp" id="exampleFormControlInput3" name="icon5" required>
                                            <!-- icon -->
                                        </div>
                                        ...
                                        <div class="mb-1">
                                            <label for="exampleFormControlInput3" class="form-label fw-bold f-title">Facility
                                                #6</label>
                                            <input type="text" class="form-control  shadow-none contact_us f6_inp" id="exampleFormControlInput3" name="f6" required>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control shadow-none contact_us icon6_inp" id="exampleFormControlInput3" name="icon6" required>
                                                <!-- icon -->
                                            </div>
                                            ...
                                            <div class="mb-1">
                                                <label for="exampleFormControlInput3" class="form-label fw-bold f-title">Facility
                                                    #7</label>
                                                <input type="text" class="form-control  shadow-none contact_us f7_inp" id="exampleFormControlInput3" name="f7" required>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control shadow-none contact_us icon7_inp" id="exampleFormControlInput3" name="icon7" required>
                                                <!-- icon -->
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary btn_edit shadow-none" onclick="update_facilities(f1.value, f2.value, f3.value, f4.value, f5.value, f6.value, f7.value, icon1.value, icon2.value, icon3.value, icon4.value, icon5.value, icon6.value, icon7.value)">Save</button>
                                    </div>
                    </form>
                </div>
            </div>
